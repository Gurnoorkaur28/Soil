...
const TestCartComponent = () => {
  const { cartItems, totalPrice, addItem, handleQuantityChange, removeItem } =
    useCart();
  ...
  return (
    <div>
      ...
      <button onClick={() => addItem(1, 2)} data-testid="addItem">
        Add Item
      </button>
      <button
      ...
      <button onClick={() => removeItem(1, 1)} data-testid="removeItem">
        Remove Item
      </button>

  ...
  test("calculates total price correctly with regular priced items", async () => {
    ...
    getUserCart.mockResolvedValue({
      cartItems: [
        {
          id: 1,
          product: { price: 10, specialProducts: [], name: "Product 1" },
          quantity: 2,
        },
        {
          id: 2,
          product: { price: 20, specialProducts: [], name: "Product 2" },
          quantity: 1,
        },
      ],
    });
      ...
      cartItems: [
        {
          ...
          product: {
            price: 10,
            specialProducts: [{ discounted_price: 8 }],
            name: "Product 1",
          },
          quantity: 2,
        },
        {
          ...
          product: {
            price: 20,
            specialProducts: [{ discounted_price: 15 }],
            name: "Product 2",
          },
          quantity: 1,
        },
